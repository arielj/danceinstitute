...
class Conn(object):
  ...
  def dev_data(cls):
    ...
    cls.execute('''INSERT INTO users (name, lastname, dni, cellphone, birthday, address, male, email, is_teacher, age) VALUES ('Ariel', 'Juod', '32496445', '0299-15-411-5106', '1/7/1986', '9 de Julio 1140', 1, 'arieljuod@gmail.com', 0, 28)''')
