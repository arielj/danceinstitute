...
class Conn(object):
  ...
  def check_version(cls):
    ...
    if version == '1.5':
      if cls._adapter == 'sqlite':
        cls.execute('ALTER TABLE klasses ADD COLUMN inactive integer default 0;')
      else:
  ...
  def dev_data(cls):
    ...
    cls.execute('''INSERT INTO schedules (klass_id, from_time, to_time, room_id, day) VALUES (1, 2000, 2200, 3, 3)''')
    cls.execute('''INSERT INTO schedules (klass_id, from_time, to_time, room_id, day) VALUES (2, 1900, 2030, 2, 1)''')
    cls.execute('''INSERT INTO schedules (klass_id, from_time, to_time, room_id, day) VALUES (2, 1900, 2000, 2, 3)''')
    ...
    cls.execute('''INSERT INTO users (name, lastname, dni, cellphone, birthday, address, male, email, is_teacher, age) VALUES ('Ariel', 'Juod', '32496445', '0299-15-411-5106', '5/7/1986', '9 de Julio 1140', 1, 'arieljuod@gmail.com', 0, 28)''')
    ...
    cls.execute('''INSERT INTO users (name, lastname, dni, cellphone, birthday, address, male, email, is_teacher, age, family) VALUES ('Juanito Alberto', 'Cumplehoy', '32496425', '0299-15-412-5106', ?, '9 de Julio 1140', 1, 'arieljuod@gmail.com', 0, 28, 100)''', (datetime.datetime.today().date(),))
    cls.execute('''INSERT INTO users (name, lastname, dni, cellphone, birthday, address, male, email, is_teacher, age, family) VALUES ('Cachito', 'Cumplehoy', '32496425', '0299-15-412-5106', ?, '9 de Julio 1140', 1, 'aried@gmail.com', 0, 28, 100)''', (datetime.datetime.today().date(),))
    cls.commit()
